...
class _SignInState extends State<SignIn> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        padding: EdgeInsets.only(left: 28.0, right: 28.0, top: 48.0, bottom: 48.0),
        child: ListView(
          ...
          children: [
                ...
                children: <Widget>[
                  ...
                  Align(
                    ...
                    child:GestureDetector(
                      ...
                      child: Text('跳过', style: TextStyle(color: Colors.grey[500], fontSize: 14)),
                    ),
                  )
                ],
              ),
            ...
            Row(
              ...
              children: <Widget>[
                Padding (
                  padding: EdgeInsets.only(right: 10),
                  child:Icon(Icons.lock_outline, color: Colors.grey[400], size: 30)
                ),
                Padding(
                  padding: EdgeInsets.only(right: 20),
                  child: Text('密码', style: TextStyle(color: Colors.grey[500], fontSize: 14)),
                ),
                Padding(
                  padding: EdgeInsets.only(right: 20),
                  child: Container(height: 20, child: VerticalDivider(color: Colors.grey[500], width: 0, thickness: 1)),
